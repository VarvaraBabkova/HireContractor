...
img_array = ["https://ehmsolutions.org/wp-content/uploads/2018/04/construction-worker-200x374.png",
	...
	"http://makeup-crematory.weebly.com/uploads/4/7/7/4/47744545/1311677_orig.jpg",
	...
	"https://d2v9y0dukr6mq2.cloudfront.net/video/thumbnail/VGqRaYUogil0szy2p/videoblocks-sad-middle-aged-man-feeling-upset-tears-in-eyes_rwg84vtve_thumbnail-full04.png",
	...
	"https://www.fpl.com/partner/images/pic-login.jpg",
	...
	"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTcApek_D_79ik-Qgcf55aVYsV2Lue9O77UBRBYSMGW9ivAQpqA",
...
20.times {
	Contractor.create(name: name_array[rand(name_array.length)], price: rand(5..30), work: "", 
		img: img_array[rand(img_array.length)], intro: "Hi!", category_id: cat1.id)
} 
...
g2 = Contractor.create(name: "Joe", price: rand(5..30), work: "Houston's gardenin", 
	...
	intro: "", category_id: cat3.id )
g3 = Contractor.create(name: "Bob", price: rand(5..30), work: "Houston's gardenin", 
